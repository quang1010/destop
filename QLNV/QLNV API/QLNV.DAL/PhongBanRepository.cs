    ...
    public class PhongBanRepository : BaseRepository, IPhongBanRepository
    {
           ...
           try
            {
                ...
                var id = SqlMapper.ExecuteScalar<int>(con, "SuaPhongBan",parameters, commandType: CommandType.StoredProcedure);
                return id;
            }
            catch(Exception ex)
            {
        ...
        public int TaoPhongBan(TaoPhongBan request)
        {
            ...
            try
            {
                ...
                parameters.Add("@MaPhongBan", request.MaPhongBan);
                parameters.Add("@TenPhongBan", request.TenPhongBan);
                var id = SqlMapper.ExecuteScalar<int>(con, "TaoPhongBan",parameters, commandType: CommandType.StoredProcedure);
                return id;
            }
            catch (Exception ex)
            {
        ...
        public bool XoaPhongBan(int Id)
        {
            try
            {
                ...
                var result = SqlMapper.ExecuteScalar<bool>(con, " XoaPhongBan",parameters, commandType: CommandType.StoredProcedure);
                return result;
            }
            catch (Exception ex)
            {
